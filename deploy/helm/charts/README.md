...
| `lvmController.snapshotController.image.tag`        | Image tag for snapshot-controller                                                | `v8.2.0`                                |
